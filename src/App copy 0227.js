...
//   const [dailyKey, setDaliyKey] = useState(Number(new Date(now.setDate(now.getDate() + when)).toISOString().substring(0,10).replace(/-/g,'')));
  
//   let loading = useFetch(setTodos, `http://localhost:4000/todos/${dailyKey}`);
...
//     setPrev(prev + 1);
//     setWhen(when - 1); //  when
//     console.log('prev when', when-1);
//     setDaliyKey(Number(new Date(now.setDate(now.getDate() - prev)).toISOString().substring(0,10).replace(/-/g,'')));
//     console.log('prev dailyKey', dailyKey);
//   }
//   const onNext = () => {
//     console.log('next');
//     setNext(next + 1);
//     setWhen(when + 1); // when
//     console.log('next when', when+1);
//     setDaliyKey(Number(new Date(now.setDate(now.getDate() + next)).toISOString().substring(0,10).replace(/-/g,'')));
//     console.log('next dailyKey', dailyKey);
//     // loading = useFetch(setTodos, `http://localhost:4000/todos/${dailyKey + when}`);
//   }
//   const openForm = () => {
